...
<main class="container" style="height: 70.9vh;">
    ...
    <div class="row">
        <div class="col-md-4">
            <img data-selected="rock" class="img-fluid" src="/img/Rock.png" alt="Rock">
        </div>
        <div class="col-md-4">
            <img id="paper" data-selected="paper" class="img-fluid" src="/img/Paper.png" alt="Paper">
        </div>
        <div class="col-md-4">
            <img id="sizer" data-selected="sizer" class="img-fluid" src="/img/Sizer.png" alt="Sizer">
        </div>
    </div>
